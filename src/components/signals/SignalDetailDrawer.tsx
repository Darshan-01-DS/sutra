...
export function SignalDetailDrawer({
  ...
  useEffect(() => {
    ...
    if (open) {
      fetch('/api/collections').then(r => r.json()).then(d => {
        setCollections(d.collections || (Array.isArray(d) ? d : []))
      }).catch(() => {})
    }
  ...
  const handleCollect = async () => {
    ...
    try {
      ...
      setSelectedCol('')
      alert('Signal added to collection!')
    } catch {
        ...
        <div className="drawer-head">
          ...
          {editingTitle ? (
            <div className="drawer-title-edit-row">
              ...
              <button className="drawer-edit-cancel" onClick={() => { setEditingTitle(false); setEditedTitle(signal?.title ?? '') }}>
                ×
              </button>
            </div>
          ) : (
            <div className="drawer-main-title-row">
              ...
              <button
                className="drawer-title-edit-btn"
            ...
            <>
              ...
              <div className="drawer-section">
                <div className="drawer-section-header">
                  ...
                  <button
                    className="drawer-section-edit-btn"
              ...
              <div className="drawer-section">
                ...
                <div className="drawer-save-row">
                  <button type="button" className="btn-ghost" onClick={() => setEditedTags(signal.tags)}>
                    Reset
                  </button>
                  <div style={{ marginLeft: 'auto', display: 'flex', gap: 8 }}>
                    <button type="button" className="btn-ghost" onClick={del} disabled={saving}>
                      Delete
                    </button>
                    <button
                      type="button"
